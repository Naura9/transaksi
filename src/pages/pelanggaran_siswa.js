...
class PelanggaranSiswa extends React.Component {
    constructor() {  
        ...
        headerConfig = () => { //memberikan authorization berupa bearer token
            let header = {
        ...
        bind = (event) => { //mengatasi event handler onchange
            this.setState({[event.target.name]: event.target.value});
        }

        getSiswa = () => { //mendapatkan data siswa yang berguna untuk ditampilkan pada dropdown form sebagai input data siswa
        ...
        getPelanggaran = () => { //mendapatkan data pelanggaran yang berguna untuk ditampilkan pada dropdown form sebagai input data pelanggaran
        ...
        getPelanggaranSiswa = () => { //untuk ditampilkan pada tabel
        ...
        ////Panggil ketiga fungsi getSiswa, getPelanggaran, dan getPelanggaranSiswa
        componentDidMount(){  
        ...
        handleDetail = (id_pelanggaran_siswa) => { //untuk menampilkan detail pelanggaran yang dilakukan oleh siswa. Fungsi ini akan mengaktifkan modal 1 yang merupakan modal untuk menampilkan detail pelanggaran siswa
        ...
        //melakukan menyimpan pelanggaran lain pada modal detail. 
        //fungsi ini akan mengaktifkan modal 2 yang merupakan modal untuk menambahkan pelanggaran
        addPelanggaran = () => {
            this.setState({
                id_pelanggaran: "",
                isModal1Open: false,
        ...
        //menghapus detail pelanggaran siswa
        ...
        //menyimpan pelanggaran siswa yang baru
        handleSave = (event) => {  
            event.preventDefault();  
    ...
    render(){
        return(
            <>
                <NavBar />
                <Card>
                <Card.Header className="card-header bg-secondary text-white" align={'center'}>Data Pelanggaran Siswa</Card.Header>
                <Card.Body>
